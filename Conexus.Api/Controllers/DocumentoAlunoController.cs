...
public class DocumentoAlunoController : ApiControllerBase
{
    ...
    [HttpGet("buscar")] //sempre especificar os verbos (o que eu quero que aconteça)
    public async Task<IActionResult> Buscar()
    {
        var result = await _DocumentoAlunoService.Buscar();
        return StatusCode(result.StatusCode, result); //retorna o status code 200
    }

    [HttpGet("buscar-todos")] //sempre especificar os verbos (o que eu quero que aconteça)
