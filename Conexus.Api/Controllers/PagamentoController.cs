...
public class PagamentoController : ApiControllerBase
{
    ...
    [HttpGet("pagamentonome")] //sempre especificar os verbos (o que eu quero que aconteça)
    public async Task<IActionResult> PagamentoNome()
    {
        var result = await _PagamentoService.PagamentoNome();
        return StatusCode(result.StatusCode, result); //retorna o status code 200
    }
