...
public interface IAvaliacaoServiceDomain
{
    ...
    Task<ApplicationResult<List<AvaliacaoDTO>>> Buscar();

    //Task<ApplicationResult<List<AvaliacaoDTO>>> BuscarTodosDetalhes();
    Task<ApplicationResult<List<AvaliacaoDetalheDTO>>> BuscarTodos();
