...
public class MaterialServiceDomain : IMaterialServiceDomain
{
    ...
    public async Task<ApplicationResult<List<MaterialDTO>>> Buscar()
{
    var materiais = _context.Materials;

    var resultMateriais = await materiais
    ...
    var result = ApplicationResult<List<MaterialDTO>>.Success(
        resultMateriais,
        200,
    ...
    public async Task<ApplicationResult<List<MaterialDetalheDTO>>> BuscarTodos()
    {
        ...
        var resultMaterials = await materials.Select(m => new MaterialDetalheDTO
        {
            ...
            TipoMaterialDescricao = m.IdtipoMaterialNavigation.Descricao,
            IdiomaDescricao = m.IdidiomaNavigation.Descricao,
            NivelDescricao = m.IdnivelNavigation.Descricao
        }).ToListAsync();

        var result = ApplicationResult<List<MaterialDetalheDTO>>.Success(resultMaterials, 200, "Registros Localizados.");
