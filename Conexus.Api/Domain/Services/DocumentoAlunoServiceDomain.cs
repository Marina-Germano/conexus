...
public class DocumentoAlunoServiceDomain : IDocumentoAlunoServiceDomain
{
    ...
    public async Task<ApplicationResult<List<DocumentoAlunoDTO>>> Buscar()
    {
    ...
    public async Task<ApplicationResult<List<DocumentoAlunoDetalheDTO>>> BuscarTodos()
{
    var documentoAlunos = _context.DocumentoAlunos;

    var resultDocumentoAlunos = await documentoAlunos
        .Select(e => new DocumentoAlunoDetalheDTO
        {
            // Iddocumento = e.Iddocumento,
            // Idaluno = e.Idaluno,
            // IdtipoDocumento = e.IdtipoDocumento,
            ...
            // 🔹 JOIN com Aluno → Usuario
            NomeUsuario = e.IdalunoNavigation != null
                ? e.IdalunoNavigation.IdusuarioNavigation.Nome
                : string.Empty,

            // 🔹 JOIN com TipoDocumento
            DescricaoDocumento = e.IdtipoDocumentoNavigation != null
                ? e.IdtipoDocumentoNavigation.Descricao
                : string.Empty
        })
        .ToListAsync();

    var result = ApplicationResult<List<DocumentoAlunoDetalheDTO>>.Success(
        resultDocumentoAlunos,
        200,
...
//             // 🔹 JOIN com Aluno → Usuario
//             NomeUsuario = e.IdalunoNavigation != null
//                 ? e.IdalunoNavigation.UsuarioNavigation.Nome
//                 : string.Empty,
...
//     var result = ApplicationResult<List<DocumentoAlunoDTO>>.Success(
//         resultDocumentoAlunos,
//         200,
//         "Registros Localizados."
//     );
